...
if ($current_month < 3 || $current_month > 11) {
    $bg_url = "img/header-bg.jpg";
} elseif ($current_month < 6) {
    $bg_url = "https://www.odgersberndtson.com/media/1249/netherlands.jpg";
} elseif ($current_month < 9) {
    $bg_url = "https://www.treatwell.co.uk/inspiration/wp-content/uploads/sites/35/2016/05/NewImages_HERO2000x1100.jpg";
} else {
    $bg_url = "http://www.skisoutheast.com/wp-content/uploads/2017/10/2017-10-19-2017-fall.jpg";
}
?>
<header style="background: url('<?php echo $bg_url; ?>') no-repeat center center;">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
        ...
        <div class="row margin-50">
            ...
            <div class="col-sm-4 pricing-container wow fadeInUp" data-wow-delay="1s">
                ...
                <ul class="list-unstyled pricing-table text-center">
                    ...
                    <li class="info">2 row section for you package information. You can include all details or icons
                    </li>
            ...
            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 wow fadeInLeft" data-wow-delay="0.8s">
                <a href="#" target="_blank">
                    ...
                    <p class="black">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam viverra orci
                        ut.<br/>
                        <small><em>Tech Crunch - January 15, 2015</em></small>
                    </p>
                </a>
            </div>
        </div>
        ...
        <div class="row margin-30 news-container">
            <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 wow fadeInLeft" data-wow-delay="1.2s">
                <a href="#" target="_blank">
                    ...
                    <p class="black">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam viverra orci ut.
                        <br/>
                        <small><em>Forbes - Feb 25, 2015</em></small>
                    </p>
                </a>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 text-right">
                <p>
                    <small>Copyright &copy; 2014. All rights reserved. <br>
                        Created by <a href="http://visualsoldiers.com">Visual Soldiers</a></small>
                </p>
            </div>
        </div>
