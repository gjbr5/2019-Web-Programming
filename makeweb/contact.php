...
<div class="section">
    ...
    <script type="text/javascript"
            src="//dapi.kakao.com/v2/maps/sdk.js?appkey=2a7e9da85ffaa60729f0bc70ae62ab31"></script>
    <script>
        new daum.maps.Map(document.getElementById('map'), {center: new daum.maps.LatLng(33.450701, 126.570667), level: 3});
    </script>
